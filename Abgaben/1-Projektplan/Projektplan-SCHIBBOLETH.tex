...
Miloevich, Olga & halfelv@tzi.de & \includegraphicstotab[scale=0.2]{olga.jpg} \\ \hline
\end{tabular}
\end{table}
...
\centering
\begin{tabular}{p{7cm}|p{7cm}}
\hline \textbf{Begriff} & \textbf{Bedeutung}\\ \hline
...
Mithilfe des Plug-ins "`Android Developer Tools"' in der Version 1.0.0.\_8-7ScKtmH6E8McIScJXJXcITh9wdNni4 können wir direkt in der IDE für Android Software entwickeln \footnote{\url{http://developer.android.com/tools/sdk/eclipse-adt.html}}.\\
