...
% Start Titelseite
  ...
  \vspace{2cm}
  \\
  \it Abgabe: 01.06.2014 --- Version 1.1\\ ~
  \end{center}
  \end{minipage}
...
Es haben sich im Kundengespräch keine großen Überraschungen oder unerwartete Kundenwünsche ergeben, die über die Mindestanforderungen besonders hinaus gehen. Einige Besonderheiten sollen aber im Folgenden näher beschrieben werden.\\
...
Des Weiteren sollen im Spiel selbst zu jeder Frage vier Antwortmöglichkeiten gegeben werden und Joker in Form eines 50:50-Jokers oder einer Zeitverlängerung eingebaut werden.\\
...
\subsection{Annahmen und Abhängigkeiten (Tim E.)}
\nurlangversion
